        ...
        NavigationStack {
            VStack {
                ...
                if let isKid = isKid {
                    NavigationLink(
                        destination: isKid ?
                            AnyView(KidSignupView(email: email, password: password, isAuthenticated: $isAuthenticated)) :
                            AnyView(AdultSignupView(email: email, password: password, isAuthenticated: $isAuthenticated))
                    ) {
                        Text("Next")
                            .frame(maxWidth: .infinity)
                            .padding()
